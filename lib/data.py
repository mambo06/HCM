...
class Dataset:
    ...
    def build_X(
        ...
        *,
        ...
        # print('shape',N['train'].shape, C['train'].shape)
        ...
        save_result(result)
        # print('save_result',
        #     result[0]['train'].shape,result[0]['test'].shape,result[0]['val'].shape
        #     ,result[1]['train'].shape,result[1]['test'].shape,result[1]['val'].shape)
